...
if exists(':VimuxRunCommand')
    nnoremap <buffer> <F1> :silent w <bar> VimuxRunCommand expand(&makeprg) . ' ' . expand("%:t")<CR>
    inoremap <buffer> <F1> <Esc>:silent w <bar> VimuxRunCommand expand(&makeprg) . ' ' . expand("%:t")<CR>
